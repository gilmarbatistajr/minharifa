...
import { ConfigurarAvisosAgenteChatbotUseCase } from './configurar-avisos-agente-chatbot.use-case';

describe('ConfigurarAvisosAgenteChatbotUseCase', () => {
  ...
  it('configura os avisos do agente chatbot do grupo', async () => {
  ...
  it('rejeita quando o grupo não pertence ao administrador solicitante', async () => {
    ...
    await expect(
      useCase.executar({ administradorId: 'admin-1', grupoId: 'grupo-1', avisaResultado: false }),
