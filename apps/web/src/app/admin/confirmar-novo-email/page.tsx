...
function Conteudo() {
  ...
  useEffect(() => {
    ...
    administradoresApi
      .confirmarNovoEmail(token)
      .then(() => setEstado('sucesso'))
      .catch((excecao) => {
        setEstado('erro');
        setMensagem(excecao instanceof ApiError ? excecao.message : 'Não foi possível confirmar o novo e-mail.');
      });
  }, [token]);
...
export default function ConfirmarNovoEmailPage() {
  return (
    <AuthLayout eyebrow="Painel administrativo" title="Confirmar novo e-mail">
